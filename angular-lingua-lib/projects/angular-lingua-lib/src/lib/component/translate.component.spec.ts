...
@Component({
  template: `
    <translate [key]="key">
      <mat-icon *translateParams="'FLAG'">flag</mat-icon>
    </translate>
  `
})
...
describe('TranslateComponent', () => {
  ...
  describe('TranslateComponent with Parameter', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        declarations: [TestTranslateWithParamsComponent],
        imports: [TranslationModule.forRoot(defaultLang), MatIconModule]
      });
    ...
    it('should put element in translation', () => {
      ...
      expect(translateEl.query(By.css('mat-icon'))).toBeTruthy();
    });
